...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main>
            <%
                CategoriesModel categoriesModel = (CategoriesModel) request.getAttribute("category");
            %>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Edit Categories <%=categoriesModel.getName()%></h1>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <input type="text" name="name" value="<%=categoriesModel.getName()%>">
